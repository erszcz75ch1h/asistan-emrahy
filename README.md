...
> # `点点例`是基于[APICloud](http://www.apicloud.com/)平台开发集工具、社交、电商、娱乐一体的移动应用！
...
* 本人使用iPhone系列手机，小米Note，小米4等主流手机测试，均可流畅运行！
* 如有闪退、卡顿问题，请留言并注明页面和手机型号，还有配置。

## App推荐配置

* IOS 8.0+ 的版本
* Android 4.4+ 的版本，系统运存大于1G

## 友情捐赠

* 如果你觉得 点点例 对你有价值，并且愿意让她继续成长下去，你可以资助这个项目的开发。

![输入图片说明](http://git.oschina.net/uploads/images/2016/0207/160936_8f2d5f2e_526496.png "在这里输入图片标题")


## 安装包信息

 * [0.3.0 Alpha IOS版本下载](http://downloadpkg.apicloud.com/app/download?path=http://7xpxtr.com1.z0.glb.clouddn.com/ecd2e034df7b847b3ad9f9b2ffc3d97e.ipa)

 * [0.3.0 Alpha Android版本下载](http://downloadpkg.apicloud.com/app/download?path=http://7xpxtr.com1.z0.glb.clouddn.com/51648fdc931e197162f05f225c389159_d)
